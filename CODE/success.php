...
if(!$row = $result->fetch_assoc()){
	...
	echo "<br>";echo "<br>";
	echo "<center>";echo "<a href='login4.php'>";echo "<h3 style='color:ghostwhite;'>";echo "Click here to Try Again";echo "</h3>";echo "</a>";echo "</center>";
}
else {
       header('location:paycategory1.php');
